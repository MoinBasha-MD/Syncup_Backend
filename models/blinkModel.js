...
// Index for finding active blinks for contacts (multiple active Blinks per user are allowed)
blinkSchema.index({ userId: 1, isActive: 1, expiresAt: -1 });

// Pre-save middleware to set expiresAt to 7 days from creation for unopened Blinks
